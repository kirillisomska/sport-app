import { getAllCompanys, updateCompanyStatus } from "@/data/company";
...
const CompanysPage = async () => {
  ...
  return (
    <div>
      <h1 className="text-2xl text-gray-900">Страница компаний</h1>
            ...
            <tr key={company.id} className="bg-white border-b">
              ...
              <td className="px-6 py-4 text-right flex flex-col gap-1">
                ...
                <form
                  action={async () => {
                    "use server";
                    await updateCompanyStatus(company.id);
