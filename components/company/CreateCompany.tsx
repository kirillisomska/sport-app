...
const CreateCompanyForm = ({ userId }: PropTypes) => {
  ...
  const handleSubmit = (values: z.infer<typeof CreateCompanySchema>) => {
    setError("");
    setSuccess("");
  ...
  return (
    <>
      <h1 className="text-2xl text-gray-900">Форма создания компании</h1>
