...
import { Company, Event, EventType, User } from "@prisma/client";
...
const UpdateEventForm = ({ company, userId, eventTypes, event }: PropTypes) => {
  ...
  const handleSubmit = (values: z.infer<typeof UpdateEventSchema>) => {
    setError("");
    setSuccess("");
  ...
  return (
    <>
      <h1 className="text-2xl text-gray-900">Форма обновления события</h1>
